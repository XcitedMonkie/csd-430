...
<%--
    Daniel Fryer
    Assignment 5/6 Dropdown control
    9/19/2026
--%>

<%
    // Setting up the variables to use inside the HTML page
    String title = "Movies Dropdown";
    String description = "Dropdown control to view a movie's details";
...
<body>
    ...
    <form action="DropdownSelect.jsp" method="post">
    ...
    <!-- Check to see if the selected movie variable is null if it is don't show the table -->
